<?php include_once('includes/header.php'); ?>
    ...
    <meta name="title" content="Our Team of Lawyers" />
    ...
    <title>Our Team of Lawyers</title>
                    ...
                    <td valign="top">
                        <div id="staff_container">
                            ...
                            <div class="staff_wrapper_table">
                                <table class="staff_dept_table" border="0" cellspacing="5" cellpadding="5" width="100%">
                                    <tbody>
                                    <tr>
                                        <td>
                                            <table class="staff_table" border="0" cellspacing="5" cellpadding="5">
                                                <tbody>
                                                <tr>
                                                    ...
                                                    <td class="bio" width="55%" align="left" valign="top">
                                                        <p>Called to the Ontario Bar, 1970
